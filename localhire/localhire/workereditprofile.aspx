<%@ Page Title="" Language="C#" MasterPageFile="~/WORKERDASHBOARD.Master" AutoEventWireup="true" CodeBehind="workereditprofile.aspx.cs" Inherits="localhire.workereditprofile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row"> 
        <div class="col"> 
            <center> 
                <asp:Image ID="ProfilePicture" class="rounded-circle" runat="server" ImageUrl="images/user%20profile%20icon.png" Height="100" Width="100" BorderStyle="Solid" BorderColor="Red" />
            </center> 
         </div> 
     </div> 
     &nbsp;
...
<%--                                         
    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="*required" Display="Dynamic" ControlToValidate="txt_pass" Font-Size="Small" Font-Bold="True" ForeColor="Red"></asp:RequiredFieldValidator>--%>
...
<%--                                       <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="*required" Display="Dynamic" ControlToValidate="txt_cpass" Font-Size="Small" Font-Bold="True" ForeColor="Red"></asp:RequiredFieldValidator>--%>
     ...
     <div class="row"> 
                                 ...
                                 <div class="col"> 
                                     ...
                                     <asp:Button ID="btnupdate" class="btn btn-success btn-block" runat="server" Text="Update" ValidationGroup="edit" OnClick="btnupdate_Click" />
