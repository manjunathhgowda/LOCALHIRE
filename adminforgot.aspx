<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="adminforgot.aspx.cs" Inherits="localhire.adminfogot" %>
                         ...
                         <div class="row">
                                 <div class="col">
                                     ...
                                     <asp:TextBox ID="txt_pass" class="form-control" runat="server" 
                                             placeholder="Enter your OTP" TextMode="Password" MaxLength="4"></asp:TextBox>
