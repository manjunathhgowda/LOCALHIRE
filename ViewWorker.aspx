<%@ Page Title="" Language="C#" MasterPageFile="~/ADMINDASHBOARD.Master" AutoEventWireup="true" CodeBehind="ViewWorker.aspx.cs" Inherits="localhire.ViewWorker" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="row">
         <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [Id], [name], [email], [mobile], [dob], [gender], [address], [ProfilePicture] FROM [worker]"></asp:SqlDataSource>
                     <div class="col">
                            <b><asp:Label ID="wrkr" runat="server"></asp:Label><asp:Label ID="Label1" runat="server" Text=" workers are present in this system"></asp:Label></b> 
                         ...
                         <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSource1" BorderStyle="Solid" BorderColor="Black" BorderWidth="3px" >
                           <Columns>
                              ...
                              <asp:TemplateField HeaderText="Worker Details">
                                 <ItemTemplate>
