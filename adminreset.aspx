<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="adminreset.aspx.cs" Inherits="localhire.adminreset" %>
...
&nbsp;<label>New Password</label>
                ...
                <a href="adminforgot.aspx" <asp:LinkButton ID="LinkButton1" runat="server">Back</asp:LinkButton></a>
            </div>
        </div>
    </div>
</asp:Content>
