<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="workerreset.aspx.cs" Inherits="localhire.workerreset" %>
...
&nbsp;<label>New Password</label>
                ...
                <a href="workerforgot.aspx" <asp:LinkButton ID="LinkButton1" runat="server">Back</asp:LinkButton></a>
            </div>
        </div>
        </div>
</asp:Content>
