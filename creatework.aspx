<%@ Page Title="" Language="C#" MasterPageFile="~/EMPLOYERDASHBOARD.Master" AutoEventWireup="true" CodeBehind="creatework.aspx.cs" Inherits="localhire.creatework" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class ="row">
        <div class="col">
         ...
         <asp:Image ID="Image2" runat="server" src="images/hour-glass.png" width="20" height="20" /> &nbsp;<label>Start Time</label> 
            <asp:TextBox ID="txt_time" class="form-control" runat="server"  TextMode="Time"></asp:TextBox>
    ...
    <div class ="row">
        ...
        <div class="col-4">
         ...
         <div class="col-4">
            ...
            <asp:Image ID="Image9" runat="server" src="images/wallet.png" width="20" height="20" /> &nbsp;<label>Pay 1 &#8377; to post a job </label> 
            <div class="row">
                <div class="col-3">
                    <asp:TextBox ID="TextBox2"  class="form-control" runat="server" value="&#8377;" ReadOnly></asp:TextBox>
                 </div>
                <div class="col-9">
                    <asp:TextBox ID="txt_pay" class="form-control" runat="server" Text="1" ReadOnly></asp:TextBox>
                </div>
            </div>
    </div>
    </div>
    ...
    <div class ="row">
        ...
        <div class="col-6">
        <centre>
            <asp:Button ID="Button1" Class="btn btn-outline-primary form-control" runat="server" Text="Post Job" ValidationGroup="creat" OnClientClick="return confirm('Are you sure want to post a job?');" OnClick="Button1_Click" />
        </centre>
        </div>
        <div class="col-3">
        </div>
