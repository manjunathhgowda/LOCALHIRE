...
namespace localhire
{
    public partial class employerfogot : System.Web.UI.Page
    {
        string randomcode;
        ...
        protected void btnsend_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("select count(*) from employer where email='" + txt_email.Text.Trim() + "'", con);
            ...
            {
                Response.Write("<script> alert('Employer does not exist');</script>");
            }
        }
        ...
        protected void btnverify_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("employerreset.aspx");
            }
            else
            {
