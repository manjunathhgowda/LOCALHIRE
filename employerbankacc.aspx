<%@ Page Title="" Language="C#" MasterPageFile="~/EMPLOYERDASHBOARD.Master" AutoEventWireup="true" CodeBehind="employerbankacc.aspx.cs" Inherits="localhire.employerbankacc" %>
...
<img src="images/cashless-payment.png" width="30" height="28" /> &nbsp;<b><i>LabourPay</i></b><br /><br /><br />
                   <div class="row"> 
                                 <div class="col"> 
                                      <center> 
                   ...
                   <hr />
                     <div class="row">
                            <div class="col">
                                     <asp:Label ID="Label1" runat="server" Text="Account Holder:" Font-Bold="true"></asp:Label>&nbsp;<asp:Label ID="acc_name" runat="server" Text="ADMIN"  Font-Bold="true"></asp:Label><br />
